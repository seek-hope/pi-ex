...
const DESCRIPTION =
	"Ask the user one or more questions when their intent cannot be determined by analysis and reasoning. " +
	"All questions in one call are asked consecutively and the answers return together. " +
	"Use whenever you genuinely cannot determine the user's intent — do not guess as a substitute. " +
				...
				content: [
					{
						...
						text:
							...
							"Proceed with your best-effort assumption and mark it with an uncertainty flag.",
					},
				],
				details: undefined,
			};
